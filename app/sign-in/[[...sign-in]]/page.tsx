        ...
        <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center p-4">
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 text-sm">Build powerful AI workflows visually</p>
                </div>
                ...
                <div className="mt-8 grid grid-cols-3 gap-4 text-center">
                    <div className="p-3 bg-gray-900/30 rounded-lg border border-gray-800">
                        ...
                        <div className="text-xs text-gray-400">Fast Execution</div>
                    </div>
                    <div className="p-3 bg-gray-900/30 rounded-lg border border-gray-800">
                        <div className="text-2xl mb-1">🤖</div>
                    ...
                    <div className="p-3 bg-gray-900/30 rounded-lg border border-gray-800">
                        <div className="text-2xl mb-1">🎨</div>
                        <div className="text-xs text-gray-400">Visual Builder</div>
                    </div>
                </div>
            </div>
        </div>
